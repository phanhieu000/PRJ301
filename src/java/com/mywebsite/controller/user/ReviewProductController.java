 ...
 * @author phanh
 */
@WebServlet(name = "ReviewProductController", urlPatterns = {"/review"})
public class ReviewProductController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String star_raw = request.getParameter("rate");
        ...
        IProductReviewDAO dao = new ProductReviewDAO();
        if (a != null) {
            dao.insert(a, id, star, content);
            String url = "productview?id=" + id;
