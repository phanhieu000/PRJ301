 ...
 * @author phanh
 */
@WebServlet(name = "AdminProductViewController", urlPatterns = {"/admin-product-details"})
public class AdminProductViewController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminProductViewController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminProductViewController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        IProductReviewDAO daoR = new ProductReviewDAO();
        request.setAttribute("product", dao.getProductByID(id));
        request.setAttribute("review", daoR.getReviewByProductID(id));
