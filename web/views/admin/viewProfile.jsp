                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="mt-1 mb-3 button-container bg-white border shadow-sm">
                                ...
                                <div class="profile-bg p-5">
                                    <c:if test="${user.information.avatar != '' }">
                                        <img id="wizardPicturePreview" src="${user.information.avatar}" height="125px" width="125px"
                                             class="rounded-circle shadow profile-img" />                    
                                    </c:if>
                                    <img id="wizardPicturePreview" src="${user.information.avatar}" height="125px" width="125px"
                                         class="rounded-circle shadow profile-img" />       
                                    <c:if test="${user.information.avatar == '' }">
                                        <c:if test="${u.information.gender == 1}">
                                            <img id="wizardPicturePreview" src="adminPugins\images\avatar-user\avatar-default-male.jpg" height="125px" width="125px"
                                                 class="rounded-circle shadow profile-img" />
                                        </c:if>

                                        <c:if test="${user.information.gender == 0}">
                                            <img id="wizardPicturePreview" src="adminPugins\images\avatar-user\avatar-default-female.jpg" height="125px" width="125px"
                                                 class="rounded-circle shadow profile-img" />
                                        </c:if>

                                        <c:if test="${user.information.gender != 1 && user.information.gender != 0}">
                                            <img id="wizardPicturePreview" src="adminPugins\images\avatar-user\avatar-default.jpg" height="125px" width="125px"
                                                 class="rounded-circle shadow profile-img" />
                                        </c:if>
                                    </c:if>
                                    <
                                ...
                                <div class="profile-bio-main container-fluid">
                                    <div class="row">
                                        <div class="col-md-5 offset-md-3 col-sm-12 offset-sm-0 col-12 bio-header">
                                            ...
                                            <c:if test="${user.information.fullName == ''}">
                                                <h3 class="mt-4">${user.userName}#${user.accountID}</h3>
                                            </c:if>

                                            <c:if test="${user.information.fullName != ''}">
                                                <h3 class="mt-4">${user.information.fullName}</h3>
                                            </c:if>
                                        </div>
                                ...
                                <div class="mb-3">
                                    <div class="row user-about">
                                        ...
                                        <div class="col-sm-4 col-4 text-center">
                                            <c:if test="${user.information.address == ''}">
                                                <h4 style="font-size: 1.3rem; padding-bottom: 0.3rem">null</h4>
                                            </c:if>
                                            <c:if test="${user.information.address != ''}">
                                                <h4 style="font-size: 1.3rem; padding-bottom: 0.3rem">${user.information.address}</h4>
                                            </c:if>
                                            <p>Address</p>
                                        </div>
                                        <div class="col-sm-4 col-4 border-left text-center">
                                            <c:if test="${user.information.birthDay == '1900-01-01'}">
                                                <h4>null</h4>
                                            </c:if>
                                            <c:if test="${user.information.birthDay != '1900-01-01'}">
                                                <h4>${user.information.age}</h4>
                                            </c:if>
                                            <p>Age</p>
                                        </div>
                                    </div>
                            ...
                            <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm custom-tabs">
                                ...
                                <div class="tab-content py-3 px-3 px-sm-0" id="nav-customContent">
                                            ...
                                            <table class="table table-borderless table-striped m-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <c:if test="${user.information.fullName != ''}">
                                                            <td>${user.information.fullName}</td>
                                                        </c:if>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <c:if test="${user.information.gender == -1}">
                                                                null
                                                            </c:if>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>${user.information.location}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="tab-pane fade p-4" id="custom-contact" role="tabpanel"
                                        ...
                                        <div class="mb-4">
                                            <h6 class="mb-2">3 Order Gần Nhất</h6>
