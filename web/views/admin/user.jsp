<%-- 
    Document   : user
    Created on : 05-10-2022, 14:06:36
    Author     : phanh
--%>
        ...
        <div class="container-fluid">
            ...
            <div class="row main-content">
                ...
                <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                    <h5 class="mb-0" ><strong>User Manager</strong></h5>
                    <span class="text-secondary">Home <i class="fa fa-angle-right"></i> User Manager</span>

                    <div class="row mt-3">
                        <div class="col-sm-12">
                            <!--Datatable-->
                            <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                                <h6 class="mb-2">User Data</h6>
                                            ...
                                            <c:forEach items="${requestScope.listU}" var="u">
                                                <tr class="text-center">
                                                    ...
                                                    <td class="align-middle">
                                                        ...
                                                        <c:if test="${u.information.avatar != null }">
                                                            <img src="${u.information.avatar}" class="rounded-pill" style="max-width: 3rem;"/>
                                                        </c:if>
                                                        <c:if test="${u.information.avatar == '' }">
                                                            <c:if test="${u.information.gender == 1}">
                                                                <img src="adminPugins\images\avatar-user\avatar-default-male.jpg" class="rounded-pill" style="max-width: 3rem;"/>
                                                            </c:if>

                                                            <c:if test="${u.information.gender == 0}">
                                                                <img src="adminPugins\images\avatar-user\avatar-default-female.jpg" class="rounded-pill" style="max-width: 3rem;"/>
                                                            </c:if>

                                                            <c:if test="${u.information.gender != 1 && u.information.gender != 0}">
                                                                <img src="adminPugins\images\avatar-user\avatar-default.jpg" class="rounded-pill" style="max-width: 3rem;"/>
                                                            </c:if>
                                                        </c:if>
                                                    </td>
                                                    <td class="align-middle">${u.amount}</td>
                                                    <td class="align-middle">
                                                        <c:if test="${u.information.address != '' || u.information.country != ''}">
                                                            ${u.information.location}
                                                        </c:if>
                                                    </td>
                                                    <td class="align-middle">
                                                        <c:if test="${u.information.date ne '01/01/1900'}">
                                                            ${u.information.date}
                                                        </c:if>
                                                    </td>
                                                    <td class="align-middle">
                                                        <c:if test="${u.information.country eq 'Việt Nam'}">
                                                            +(84) ${u.information.phone}
                                                        </c:if>
                                                        <c:if test="${u.information.country ne 'Việt Nam'}">
                                                            ${u.information.phone}
                                                        </c:if>
                                                    </td>
                                                    <td class="align-middle">
                                                    ...
                                                    <c:if test="${account.action.viewAccount eq true || account.action.updateAccount eq true || account.action.deleteAccount eq true}">
                                                        <td class="align-middle">
                                                            <c:if test="${account.action.viewAccount eq true}">
                                                                <a href="admin-viewprofile?id=${u.accountID}">
