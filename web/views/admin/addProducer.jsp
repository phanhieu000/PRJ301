<%-- 
    ...
    Created on : 01-11-2022, 19:28:11
    Author     : phanh
--%>
...
<html lang="en">
    <head>
        ...
        <!--Switchery CSS-->
        <link rel="stylesheet" href="adminPugins/assets/css/switchery.min.css">
        <!--Bootstrap tagsinput css-->
        <link rel="stylesheet" href="adminPugins/assets/css/bootstrap-tagsinput.css">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row main-content">
                ...
                <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                    <h5 class="mb-0" ><strong>Thêm Nhà Sản Xuất</strong></h5>
                            ...
                            <div class="mt-4 mb-3 p-3 button-container bg-white border shadow-sm">
                                ...
                                <form action="" method="post">
                                    <div class="form-group floating-label">
                                        <select name="categoryID" id="cid"  class="custom-select" required onchange="changeCategory()">
                                            <option value=""></option>
                                            <c:forEach items="${cd.allAndSubcategory}" var="c">
                                    ...
                                    <div class="form-group floating-label">
                                        <input class="form-control" type="text" name="producerName" required>
                                        <label for="">Producer Name</label>

                                    </div>
                                    <div class="form-group floating-label">
                                        <input class="form-control" type="text" id="pmt" value="" name="producerMeta" required >
                                        <label for="" >Producer Meta</label>
                                    </div>
                                    <div class="form-group floating-label">
                                ...
                                <script>
                                    function changeCategory(){
                                        ...
                                        document.getElementById('pmt').value = value;
                                    }
                                </script>
                            </div>
                            <!--Floating label-->
        ...
        <!--Bootstrap Calendar-->
        <!--Switchery JS-->
        <script src="adminPugins/assets/js/switchery.min.js"></script>
        <!--Bootstrap tagsinput-->
        <script src="adminPugins/assets/js/bootstrap-tagsinput.min.js"></script>
