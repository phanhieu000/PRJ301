                        ...
                        <div class="col-sm-12 col-md-4">
                            <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                                ...
                                <div class="mb-3">
                                    <div class="row user-about">
                                        ...
                                        <div class="col-sm-4 col-4 text-center">
                                            <h4 style="font-size: 1.3rem; padding-bottom: 0.3rem">${account.information.address}</h4>
                                            <p>Address</p>
                                        </div>
                                ...
                                <div class="mb-3 ">
                                    ...
                                    <p class="p-typo text-center">${account.information.status}</p>
                                            ...
                                            <table class="table table-borderless table-striped m-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>${account.information.fullName}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Gender</th>
                                                        <td>
                                                            <c:if test="${account.information.gender == 1}">
                                                                Male
                                                            </c:if>
                                                            <c:if test="${account.information.gender == 0}">
                                                                Female
                                                            </c:if>
                                                            <c:if test="${account.information.gender != 1 && account.information.gender != 0}">
                                                                null
                                                            </c:if>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>${account.information.date}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Role</th>
                                                        <td>${account.action.adminRole}</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">Location</th>
                                                        <td>${account.information.location}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
