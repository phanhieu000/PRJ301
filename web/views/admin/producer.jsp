                                ...
                                <table class="table table-bordered table-striped mt-3" id="productList">
                                    <thead>
                                        <tr>
                                            ...
                                            <th  class="align-middle text-center">Producer Name</th>
                                            <th  class="align-middle text-center">Producer Meta</th>
                                            <th  class="align-middle text-center">Country</th>
                                            <th class="align-middle text-center">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <jsp:useBean id="pd" class="com.mywebsite.DAO.product.ProducerDAO"/>
                                        <c:forEach items="${pd.all}" var="p">
                                            <tr>
                                                <td class="align-middle text-center">${p.producerID}</td>
                                                ...
                                                <td class="align-middle text-center">${p.country}</td>
                                                
                                                <td class="align-middle text-center">
                                                    <button class="btn btn-success" data-toggle="modal" data-target="#order${o.orderID}"><i class="fa fa-pencil"></i></button>
                                                    <a href="delete-producer?id=${p.producerID}"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
