        ...
        <div class="container-fluid">
            ...
            <div class="row main-content">
                ...
                <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                    ...
                    <span class="text-secondary">Home <i class="fa fa-angle-right"></i> Danh Sách Category</span>
                                ...
                                <table class="table table-bordered table-striped mt-3" id="productList">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="15%" class="align-middle text-center">Category Name</th>
                                            <th width="14%" class="align-middle text-center">CategoryParentID</th>
                                            <th class="align-middle text-center">Category Metatitle</th>
                                            <th class="align-middle text-center">Category Create At</th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${cd.allAndSubcategory}" var="c">
                                            <tr>
                                                <td class="align-middle text-center">${c.categoryID}</td>
                                                ...
                                                <td class="align-middle text-center">${c.categoryMetaTitle}</td>
                                                <td class="align-middle text-center">${c.categoryCreateAt}</td>
                                                <td class="align-middle text-center">
                                                    <button class="btn btn-success" data-toggle="modal" data-target="#order${o.orderID}"><i class="fa fa-pencil"></i></button>
                                                    <a href="delete-category?id=${c.categoryID}"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
