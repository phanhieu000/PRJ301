<%-- 
    Document   : cart
    Created on : 19-09-2022, 10:03:23
    Author     : phanh
--%>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach  items="${cart.items}" var="i">
                                            ...
                                            <tr>
                                        <form action="process" name="formCart">
                                            <td class="li-product-thumbnail"><a href="#"><img width="120px"  src="${i.product.image.imageFirst}" alt="Li's Product Image"></a></td>
                                            <td class="li-product-name"><a href="productview?id=${i.product.productID}">${i.product.productName}</a></td>
                                            <td class="li-product-price"><span class="amount">${i.unitPriceFormat}</span></td>
                                            <td class="quantity">
                                                <select name="color" onchange="this.form.submit()">
                                                    <c:if test="${i.product.color.colorFirst != null}">
                                                        <option value="1" ${i.color == 1 ? 'selected' : ''}>${i.product.color.colorFirst}</option>
                                                    </c:if>
                                                    <c:if test="${i.product.color.colorSecond != null}">
                                                        <option value="2" ${i.color == 2 ? 'selected' : ''}>${i.product.color.colorSecond}</option>
                                                    </c:if>
                                                    <c:if test="${i.product.color.colorThree != null}">
                                                        <option value="3" ${i.color == 3 ? 'selected' : ''}>${i.product.color.colorThree}</option>
                                                    </c:if>
                                                    <c:if test="${i.product.color.colorFour != null}">
                                                        <option value="4" ${i.color == 4 ? 'selected' : ''}>${i.product.color.colorFour}</option>
                                                    </c:if>
                                                    <c:if test="${i.product.color.colorFive != null}">
                                                        <option value="5" ${i.color == 5 ? 'selected' : ''}>${i.product.color.colorFive}</option>
                                                    </c:if>
                                                </select>
                                                <input type="text" name="id" value="${i.product.productID}" hidden>
                                            ...
                                            <td class="quantity">
                                                <div class="cart-plus-minus">
                                                    ...
                                                    <a href="process?id=${i.product.productID}&quantity=-1&color=${i.color}"><div class="dec qtybutton">
                                                            <i class="fa fa-angle-down"></i>
                                                        </div></a>
                                                    <a href="process?id=${i.product.productID}&quantity=1&color=${i.color}"><div class="inc qtybutton"><i class="fa fa-angle-up"></i></div></a>
                                                </div>

                                            </td>
                                            <td class="product-subtotal"><span class="amount">${i.totalMoneyFormat}</span></td>
                                            <td class="li-product-remove"><a href="process?action=delete&id=${i.product.productID}"><i class="fa fa-times"></i></a></td>
                                        </form>
                                        </tr>
                                    </c:forEach>  
                                    </tbody>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="coupon-all">
                                        <div class="coupon2">
                                            <input id="coupon_code" class="coupon-text"   placeholder="Mã Giảm Giá: " type="text">
                                            <input class="button"  value="Apply coupon" type="button">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-5 ml-auto">
                                    <div class="cart-page-total">
                                        <h2>Cart totals</h2>
                                        <ul>
                                            <li>Subtotal <span>${requestScope.totalMoneyFormat} VND</span></li>
                                            <li>Tax (1%): <span>${requestScope.tax} VND </span></li>
                                            <li>Total <span>${requestScope.totalMoneyTax} VND</span></li>
                                        </ul>
