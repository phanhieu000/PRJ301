                ...
                <div class="container">
                    <div class="row">
                            ...
                            <form action="register" method="post">
                                <div class="login-form">
                                    ...
                                    <c:if test="${requestScope.registerError != null}">
                                        <h6 class="mb-20 text-center" style="color: red">${requestScope.registerError}</h6>
                                    </c:if>
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>First Name</label>
                                            <input class="mb-0" type="text" placeholder="Họ" name="firstName" required>
                                        </div>
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>Last Name</label>
                                            <input class="mb-0" type="text" placeholder="Tên" name="lastName" required>
                                        </div>
                                        <div class="col-md-12 mb-20">
                                            <label>Email <span class="required">*</span></label>
                                            <input class="mb-0" type="email" placeholder="Nhập Email Của Bạn" name="email" required>
                                        ...
                                        <div class="col-md-12 mb-20">
                                            ...
                                            <input class="mb-0" type="text" placeholder="Nhập Tài Khoản" name="userName" required>
                                        ...
                                        <div class="col-md-6 mb-20">
                                            ...
                                            <input class="mb-0" type="password" placeholder="Nhập Mật Khẩu" name="password" required>
                                        </div>
                                        <div class="col-md-6 mb-20">
                                            <label>Confirm Password <span class="required">*</span></label>
                                            <input class="mb-0" type="password" placeholder="Xác Nhận Mật Khẩu" name="re-password" required>
                                        </div>  
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-4 col-xs-12">
                            <img style="width: 150%; height: 100%;" src="userPugins/images/login.png" alt="fpt">
                        </div>
                    </div>
                </div>
            </div>
