<%-- 
    Document   : profile
    Created on : 17-10-2022, 22:46:00
    Author     : phanh
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                            <div class="contact-page-side-content">
                                <h3 class="contact-page-title">Địa Chỉ Nhận Hàng</h3>
                                <p class="contact-page-message mb-25">Sản Phẩm Này Tạo Bởi Phan Hiếu</p>
                                <div class="single-contact-block">
                                    <h4><i class="fa fa-fax"></i> Address</h4>
                                    <p>${account.information.address}, ${account.information.country.countryName}</p>
                                </div>
                                <div class="single-contact-block">
                                    <h4><i class="fa fa-phone"></i> Phone</h4>
                                    <p>Số Điện Thoại: ${account.information.phone}</p>
                                    <p class="text-danger">Hotline: 0838456798 (ADMIN)</p>
                                </div>
                                <div class="single-contact-block last-child">
                                    <h4><i class="fa fa-envelope-o"></i> Email</h4>
                                    <p>${account.email}</p>
                                    <p class="text-danger">Email ADMIN: hieupmhe163385@fpt.edu.vn</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <form  action="profile" method="post">
                                        ...
                                        <div class="form-group row">
                                            <div class=" col-md-6">
                                                ...
                                                <input type="text" name="firstName" class="form-control" id="firstName" value="${account.information.firstName}" disabled>
                                            </div>
                                            <div class=" col-md-6">
                                                <label>Last Name <span class="required">*</span></label>
                                                <input type="text" name="lastName" class="form-control" id="lastName" value="${account.information.lastName}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Your Email <span class="required">*</span></label>
                                            <input type="email" name="email" class="form-control" id="email" value="${account.email}" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input type="text" name="phone" class="form-control" id="phone" value="${account.information.phone}" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" name="address" id="address" class="form-control" id="changeProfile" value="${account.information.address}" disabled>
                                        </div>

                                        <div class="form-group">
                                            <button type="button" value="Chỉnh Sửa" id="change" class="li-btn-3" onclick="changeProfiles()">Chỉnh Sửa</button>

                                            <button type="submit" value="submit" id="submit" class="li-btn-3" hidden>SAVE</button>
