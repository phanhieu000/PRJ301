<%-- 
    Document   : order
    Created on : 27-10-2022, 16:08:48
    Author     : phanh
--%>
                        ...
                        <div class="col-12">
                            <c:if test="${account != null}">
                                <c:if test="${orderHistory.size() == 0}">
                                    <h5 class="text-center">Bạn Chưa Có Order Nào. <small><a href="shop">Shop?</a></small></h5>
                                </c:if>
                                <c:if test="${orderHistory.size() != 0}">
                                    <form action="#">
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="cart-product-name" style="width: 30%">Sản Phẩm</th>
                                                        <th class="li-product-price">Giá Thành</th>
                                                        <th class="li-product-price">Số Lượng</th>
                                                        <th class="li-product-stock-status">Thời Gian Đặt Hàng</th>
                                                    ...
                                                    <c:forEach items="${orderHistory}" var="o">
                                                        <tr>
                                                            <td class="li-product-thumbnail"><a href="#">
                                                                    <img width="100px" src="${o.product.image.imageFirst}" alt=""></a>
                                                            </td>
                                                            <td class="li-product-name"><a href="productview?id=${o.product.productID}">${o.product.productName}</a></td>
                                                            <td class="li-product-price"><span class="amount">${o.product.lastPriceFormat}</span></td>
                                                            <td class="li-product-name"><span class="amount">${o.quantity}</span></td>
                                                            <td class="li-product-stock-status">${o.order.dateFormat}</td>
                                                            <td class="li-product-stock-status">
                                                                <span class="${o.order.status == 1 ? 'text-success' : 'text-warning'} ">
                                                                    ${o.order.status == 1 ? 'Hoàn Thành' : ''}
                                                                    ${o.order.status == 0 ? 'Chờ Xử Lý' : ''}
                                                                </span>
                                                            </td>
                                        ...
                                        <ul class="pagination justify-content-center mt-10">
                                            <li class="page-item ${page == 1 ? 'disabled' : ''}"><a class="page-link" href="order?page=${page - 1}">Previous</a></li>
                                                <c:forEach begin="${1}" end="${numberPage}" var="i">
                                                <li class="page-item ${i==page ? "active" : ""}"><a class="page-link"
                                                                                                    href="order?page=${i}">${i}</a></li>
                                                </c:forEach>
                                            <li class="page-item ${page == numberPage ? 'disabled' : ''}"><a class="page-link" href="order?page=${page + 1}">Next</a></li>
                                        </ul>
                                    </form>
                            ...
                            <c:if test="${account == null}">
                                <h4 class="text-center">Đăng Nhập Để Xem Order? <small><a href="login">Đăng Nhập</a></small></h4>
                            </c:if>
